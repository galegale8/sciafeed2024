...
def test_parse_row():
    ...
    # full parsing
    expected = [
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'FF', 90.0, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'DD', 355.0, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Tmedia', 680.0, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Tmin', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Tmax', None, False],
        ...
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'UR media', 83.0, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'UR min', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'UR max', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), '12', 102050.0, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'P', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Pmin', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Pmax', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'RADSOL', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'INSOL', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'PREC', None, False],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Bagnatura_f', None, False]
    ]
...
def test_parse():
    ...
    metadata = {'cod_utente': '70001', 'lat': 43.876999,
                ...
                'source': 'arpa19/loc01_70001_201301010000_201401010100.dat'}
    expected_data = [
        [metadata, datetime(2013, 1, 1, 0, 0), 'FF', 90.0, True],
        [metadata, datetime(2013, 1, 1, 0, 0), 'DD', 355.0, True],
        [metadata, datetime(2013, 1, 1, 0, 0), 'Tmedia', 680.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 0, 0), 'UR media', 83.0, True],
        [metadata, datetime(2013, 1, 1, 0, 0), 'UR min', None, False],
        [metadata, datetime(2013, 1, 1, 0, 0), 'UR max', None, False],
        [metadata, datetime(2013, 1, 1, 0, 0), '12', 102050.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 1, 0), 'FF', 60.0, True],
        [metadata, datetime(2013, 1, 1, 1, 0), 'DD', 310.0, True],
        [metadata, datetime(2013, 1, 1, 1, 0), 'Tmedia', 650.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 1, 0), '12', 101980.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 2, 0), 'FF', 30.0, True],
        [metadata, datetime(2013, 1, 1, 2, 0), 'DD', 288.0, True],
        [metadata, datetime(2013, 1, 1, 2, 0), 'Tmedia', 630.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 2, 0), 'UR media', 86.0, True],
        [metadata, datetime(2013, 1, 1, 2, 0), 'UR min', None, False],
        [metadata, datetime(2013, 1, 1, 2, 0), 'UR max', None, False],
        [metadata, datetime(2013, 1, 1, 2, 0), '12', 101960.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 3, 0), 'FF', 110.0, True],
        [metadata, datetime(2013, 1, 1, 3, 0), 'DD', 357.0, True],
        [metadata, datetime(2013, 1, 1, 3, 0), 'Tmedia', 630.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 3, 0), 'UR media', 87.0, True],
        [metadata, datetime(2013, 1, 1, 3, 0), 'UR min', None, False],
        [metadata, datetime(2013, 1, 1, 3, 0), 'UR max', None, False],
        [metadata, datetime(2013, 1, 1, 3, 0), '12', 101890.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 4, 0), 'FF', 90.0, True],
        [metadata, datetime(2013, 1, 1, 4, 0), 'DD', 1.0, True],
        [metadata, datetime(2013, 1, 1, 4, 0), 'Tmedia', 640.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 4, 0), 'UR media', 88.0, True],
        [metadata, datetime(2013, 1, 1, 4, 0), 'UR min', None, False],
        [metadata, datetime(2013, 1, 1, 4, 0), 'UR max', None, False],
        [metadata, datetime(2013, 1, 1, 4, 0), '12', 101840.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 5, 0), 'FF', 300.0, True],
        [metadata, datetime(2013, 1, 1, 5, 0), 'DD', 6.0, True],
        [metadata, datetime(2013, 1, 1, 5, 0), 'Tmedia', 670.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 5, 0), 'UR media', 89.0, True],
        [metadata, datetime(2013, 1, 1, 5, 0), 'UR min', None, False],
        [metadata, datetime(2013, 1, 1, 5, 0), 'UR max', None, False],
        [metadata, datetime(2013, 1, 1, 5, 0), '12', 101810.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 6, 0), 'FF', 310.0, True],
        [metadata, datetime(2013, 1, 1, 6, 0), 'DD', 6.0, True],
        [metadata, datetime(2013, 1, 1, 6, 0), 'Tmedia', 650.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 6, 0), '12', 101810.0, True],
