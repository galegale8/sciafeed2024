...
def test_extract_metadata(tmpdir):
    ...
    assert stat_props == {'cod_utente': '70001'}
...
def test_parse():
    ...
    expected_data = [
        ...
        [stat_props, datetime(2013, 1, 1, 1, 0), '2', 310.0, True],
        ...
        [stat_props, datetime(2013, 1, 1, 2, 0), '3', 63.0, True],
        ...
        [stat_props, datetime(2013, 1, 1, 4, 0), '3', 64.0, True],
        ...
        [stat_props, datetime(2013, 1, 1, 5, 0), '3', 67.0, True],
        ...
        [stat_props, datetime(2013, 1, 1, 6, 0), '3', 65.0, True],
