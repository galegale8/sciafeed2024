...
def test_parse_row():
    ...
    # full parsing
    expected = [
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'FF', 0.9, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'DD', 355.0, True],
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), 'Tmedia', 6.8, True],
        ...
        [{'lat': 43.876999}, datetime(2013, 1, 1, 0, 0), '12', 1020.5, True],
...
def test_parse():
    ...
    metadata = {'cod_utente': '70001', 'lat': 43.876999,
                ...
                'source': 'arpa19/loc01_70001_201301010000_201401010100.dat'}
    expected_data = [
        [metadata, datetime(2013, 1, 1, 0, 0), 'FF', 0.9, True],
        [metadata, datetime(2013, 1, 1, 0, 0), 'DD', 355.0, True],
        [metadata, datetime(2013, 1, 1, 0, 0), 'Tmedia', 6.8, True],
        ...
        [metadata, datetime(2013, 1, 1, 0, 0), '12', 1020.5, True],
        ...
        [metadata, datetime(2013, 1, 1, 1, 0), 'FF', 0.6, True],
        [metadata, datetime(2013, 1, 1, 1, 0), 'DD', 310.0, True],
        [metadata, datetime(2013, 1, 1, 1, 0), 'Tmedia', 6.5, True],
        ...
        [metadata, datetime(2013, 1, 1, 1, 0), '12', 1019.8, True],
        ...
        [metadata, datetime(2013, 1, 1, 2, 0), 'FF', 0.3, True],
        ...
        [metadata, datetime(2013, 1, 1, 2, 0), '12', 1019.6, True],
        ...
        [metadata, datetime(2013, 1, 1, 3, 0), 'FF', 1.1, True],
        [metadata, datetime(2013, 1, 1, 3, 0), 'DD', 357.0, True],
        [metadata, datetime(2013, 1, 1, 3, 0), 'Tmedia', 6.3, True],
        ...
        [metadata, datetime(2013, 1, 1, 3, 0), '12', 1018.9, True],
        ...
        [metadata, datetime(2013, 1, 1, 4, 0), 'FF', 0.9, True],
        [metadata, datetime(2013, 1, 1, 4, 0), 'DD', 1.0, True],
        [metadata, datetime(2013, 1, 1, 4, 0), 'Tmedia', 6.4, True],
        ...
        [metadata, datetime(2013, 1, 1, 4, 0), '12', 1018.4, True],
        ...
        [metadata, datetime(2013, 1, 1, 5, 0), 'FF', 3.0, True],
        [metadata, datetime(2013, 1, 1, 5, 0), 'DD', 6.0, True],
        [metadata, datetime(2013, 1, 1, 5, 0), 'Tmedia', 6.7, True],
        ...
        [metadata, datetime(2013, 1, 1, 6, 0), 'FF', 3.1, True],
        ...
        [metadata, datetime(2013, 1, 1, 6, 0), '12', 1018.1, True],
