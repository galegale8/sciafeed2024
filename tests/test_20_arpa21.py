...
def test_parse():
    ...
    expected_data = [
        ...
        [stat_props, datetime(2012, 1, 1, 0, 0), '9', 83.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 1, 0), '4', 52.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 2, 0), '5', 58.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 2, 0), '9', 79.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 3, 0), '9', 82.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 4, 0), '9', 84.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 5, 0), '9', 84.0, True],
        ...
        [stat_props, datetime(2012, 1, 1, 6, 0), '9', 84.0, True],
