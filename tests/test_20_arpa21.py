...
def test_parse():
    ...
    expected_data = [
        [metadata, datetime(2012, 1, 1, 0, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '2', 242.0, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '3', 57.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), '4', 55.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), '5', 60.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), '9', 83.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), '10', 80.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), '11', 85.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 0, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '2', 354.0, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '3', 56.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), '4', 52.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), '5', 59.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 1, 0), '9', 81.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), '10', 79.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), '11', 83.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 1, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '2', 184.0, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '3', 56.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), '4', 53.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), '5', 58.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), '9', 79.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), '10', 79.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), '11', 81.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 2, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '2', 244.0, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '3', 50.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), '4', 46.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), '5', 57.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 3, 0), '9', 82.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), '10', 79.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), '11', 85.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 3, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '2', 198.0, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '3', 44.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), '4', 39.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), '5', 50.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 4, 0), '9', 84.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), '10', 82.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), '11', 87.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 4, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '2', 198.0, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '3', 46.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), '4', 39.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), '5', 49.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 5, 0), '9', 84.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), '10', 83.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), '11', 88.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 5, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '2', 276.0, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '3', 50.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), '4', 44.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), '5', 59.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 6, 0), '9', 84.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), '10', 82.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), '11', 86.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 6, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), '21', None, False]
    ]
