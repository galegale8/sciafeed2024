...
def test_parse_row():
    ...
    expected = [
        ...
        [{'lat': 37.33913}, datetime(2012, 1, 1, 0, 0), 'Tmedia', 570.0, True],
        [{'lat': 37.33913}, datetime(2012, 1, 1, 0, 0), 'Tmin', 550.0, True],
        [{'lat': 37.33913}, datetime(2012, 1, 1, 0, 0), 'Tmax', 600.0, True],
...
def test_parse():
    ...
    expected_data = [
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), 'Tmedia', 570.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), 'Tmin', 550.0, True],
        [metadata, datetime(2012, 1, 1, 0, 0), 'Tmax', 600.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 1, 0), 'Tmedia', 560.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), 'Tmin', 520.0, True],
        [metadata, datetime(2012, 1, 1, 1, 0), 'Tmax', 590.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), 'Tmedia', 560.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), 'Tmin', 530.0, True],
        [metadata, datetime(2012, 1, 1, 2, 0), 'Tmax', 580.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 3, 0), 'Tmedia', 500.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), 'Tmin', 460.0, True],
        [metadata, datetime(2012, 1, 1, 3, 0), 'Tmax', 570.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 4, 0), 'Tmedia', 440.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), 'Tmin', 390.0, True],
        [metadata, datetime(2012, 1, 1, 4, 0), 'Tmax', 500.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 5, 0), 'Tmedia', 460.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), 'Tmin', 390.0, True],
        [metadata, datetime(2012, 1, 1, 5, 0), 'Tmax', 490.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 6, 0), 'Tmedia', 500.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), 'Tmin', 440.0, True],
        [metadata, datetime(2012, 1, 1, 6, 0), 'Tmax', 590.0, True],
