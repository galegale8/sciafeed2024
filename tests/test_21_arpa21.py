...
def test_parse_row():
    ...
    # full parsing
    expected = [
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'FF', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'DD', 242.0, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'Tmedia', 5.7, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'Tmin', 5.5, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'Tmax', 6.0, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), '6', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), '7', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), '8', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'UR media', 83.0, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'UR min', 80.0, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'UR max', 85.0, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), '12', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'P', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'Pmin', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'Pmax', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'RADSOL', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), '17', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), '18', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'INSOL_00', None, False],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'PREC', 0.0, True],
        [{'lat': 37.33913}, datetime(2011, 12, 31, 23, 0), 'Bagnatura_f', None, False]
    ]
...
def test_parse():
    ...
    expected_data = [
        ...
        [metadata, datetime(2011, 12, 31, 23, 0), 'UR media', 83.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), 'Tmin', 5.2, True],
        ...
        [metadata, datetime(2012, 1, 1, 1, 0), 'Tmax', 5.8, True],
        ...
        [metadata, datetime(2012, 1, 1, 1, 0), 'UR media', 79.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), 'UR media', 82.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 3, 0), 'UR media', 84.0, True],
    ...
    for i, record in enumerate(effective):
        assert effective[i][1:] == expected_data_valid[i][1:]
