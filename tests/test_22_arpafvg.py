...
def test_parse_row():
    ...
    # full parsing
    expected = [
        [{'lat': 46.077222}, datetime(2018, 1, 1, 1, 0), 'PREC', 0.0, True],
        [{'lat': 46.077222}, datetime(2018, 1, 1, 1, 0), 'Tmedia', 2.8, True],
        [{'lat': 46.077222}, datetime(2018, 1, 1, 1, 0), 'UR media', 86.0, True],
        [{'lat': 46.077222}, datetime(2018, 1, 1, 1, 0), 'Bagnatura_f', 58.0, True],
...
def test_parse():
    ...
    expected_data = [
        ...
        [metadata, datetime(2018, 1, 1, 1, 0), 'UR media', 86.0, True],
        [metadata, datetime(2018, 1, 1, 1, 0), 'Bagnatura_f', 58.0, True],
        [metadata, datetime(2018, 1, 1, 1, 0), 'DD', 357.0, True],
        [metadata, datetime(2018, 1, 1, 1, 0), 'FF', 0.5, True],
        ...
        [metadata, datetime(2018, 1, 1, 2, 0), 'Bagnatura_f', 59.0, True],
        ...
        [metadata, datetime(2018, 1, 1, 3, 0), 'Bagnatura_f', 39.0, True],
        [metadata, datetime(2018, 1, 1, 3, 0), 'DD', 345.0, True],
        [metadata, datetime(2018, 1, 1, 3, 0), 'FF', 1.2, True],
        [metadata, datetime(2018, 1, 1, 3, 0), 'Pstaz', 1000.0, True],
        ...
        [metadata, datetime(2018, 1, 1, 4, 0), 'UR media', 82.0, True],
        [metadata, datetime(2018, 1, 1, 4, 0), 'Bagnatura_f', 0.0, True],
        [metadata, datetime(2018, 1, 1, 4, 0), 'DD', 313.0, True],
        [metadata, datetime(2018, 1, 1, 4, 0), 'FF', 1.8, True],
        [metadata, datetime(2018, 1, 1, 4, 0), 'Pstaz', 999.0, True],
        [metadata, datetime(2018, 1, 1, 4, 0), 'RADSOL', 0.0, True],
        [metadata, datetime(2018, 1, 1, 4, 0), 'INSOL', 0.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'PREC', 0.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'Tmedia', 3.4, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'UR media', 83.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'Bagnatura_f', 0.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'DD', 348.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'FF', 0.9, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'Pstaz', 998.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'RADSOL', 0.0, True],
        [metadata, datetime(2018, 1, 1, 5, 0), 'INSOL', 0.0, True]
    ]
