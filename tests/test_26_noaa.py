...
def test_parse():
    ...
    effective, err_msgs = noaa.parse(filepath, parameters_filepath=parameters_filepath)
    ...
    assert err_msgs == noaa.validate_format(filepath, parameters_filepath=parameters_filepath)
