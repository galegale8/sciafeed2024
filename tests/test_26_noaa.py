...
def test_parse_row():
    ...
    expected = [
        [metadata, datetime(2019, 1, 1, 0, 0), 'Tmedia', 33.9, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'DEWP', 23.7, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'STP', 859.6, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'VISIB', 11.0, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'FF', 7.9, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'MXSPD', 11.1, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'Tmax', 41.0, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'Tmin', 28.4, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'SNDP', 1.6, True]
    ]
...
def test_parse():
    ...
    expected_data = [
        ...
        [metadata, datetime(2019, 1, 1, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 1, 0, 0), 'SNDP', 1.6, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'Tmedia', 25.5, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'DEWP', 15.5, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'STP', 855.1, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'VISIB', 4.8, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'FF', 7.9, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'MXSPD', 11.1, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'Tmax', 32.4, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'Tmin', 19.4, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 2, 0, 0), 'SNDP', 1.6, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'Tmedia', 19.3, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'DEWP', 4.3, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'STP', 860.1, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'VISIB', 7.1, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'FF', 7.9, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'MXSPD', 9.9, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'Tmax', 26.2, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'Tmin', 17.2, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 3, 0, 0), 'SNDP', 1.6, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'Tmedia', 23.0, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'DEWP', 10.9, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'STP', 859.6, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'VISIB', 12.6, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'FF', 11.6, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'MXSPD', 17.1, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'Tmax', 29.5, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'Tmin', 17.2, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 4, 0, 0), 'SNDP', 1.6, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'Tmedia', 26.5, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'DEWP', 23.7, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'STP', 857.4, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'VISIB', 4.8, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'FF', 7.2, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'MXSPD', 11.1, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'Tmax', 39.2, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'Tmin', 21.9, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'PREC', 0.08, True],
        [metadata, datetime(2019, 1, 5, 0, 0), 'SNDP', 3.5, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'Tmedia', 29.3, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'DEWP', 23.3, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'STP', 857.8, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'VISIB', 7.9, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'FF', 7.5, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'MXSPD', 8.9, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'Tmax', 34.2, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'Tmin', 27.0, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 6, 0, 0), 'SNDP', 4.7, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'Tmedia', 27.8, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'DEWP', 21.7, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'STP', 858.9, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'VISIB', 7.4, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'FF', 7.1, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'MXSPD', 8.9, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'Tmax', 32.4, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'Tmin', 23.0, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(2019, 1, 7, 0, 0), 'SNDP', 4.7, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'Tmedia', 28.1, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'DEWP', 24.0, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'STP', 848.0, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'VISIB', 3.5, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'FF', 5.7, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'MXSPD', 8.0, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'Tmax', 35.2, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'Tmin', 21.6, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'PREC', 0.12, True],
        [metadata, datetime(2019, 1, 8, 0, 0), 'SNDP', 5.9, True]
    ]
