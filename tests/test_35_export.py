...
def test_export2csv(tmpdir):
    ...
    expected_rows = [
        ...
        '70001;;2013-01-01;00:00:00;1;9.0;1;afile/path;arpa19;43.876999;\n',
        '70001;;2013-02-01;00:00:00;3;68.0;1;afile/path;arpa19;43.876999;\n',
        '70001;;2014-01-01;00:00:00;2;355.0;0;afile/path;arpa19;43.876999;\n'
    ]
    ...
    expected_rows = [
        'cod_utente;cod_rete;date;time;parameter;value;valid;source;format;lat;lon\n',
        '70001;;2013-01-01;00:00:00;1;9.0;1;afile/path;arpa19;43.876999;\n',
        '70001;;2013-01-01;00:04:00;6;22;0;afile/path;arpa19;43.876999;\n',
        '70001;;2013-01-01;03:00:00;5;;0;afile/path;arpa19;43.876999;\n',
        '70001;;2013-01-02;00:00:00;4;;1;afile/path;arpa19;43.876999;\n',
        '70001;;2013-02-01;00:00:00;3;68.0;1;afile/path;arpa19;43.876999;\n',
        '70001;;2014-01-01;00:00:00;2;355.0;0;afile/path;arpa19;43.876999;\n'
    ]
    ...
    expected_rows = [
        'cod_utente;cod_rete;date;time;parameter;value;valid;source;format;lat;lon\n',
        '70001;;2013-01-01;;1;9.0;1;afile/path;arpa19;43.876999;\n',
        '70001;;2013-01-01;;5;;0;afile/path;arpa19;43.876999;\n',
        '70001;;2013-01-01;;6;22;0;afile/path;arpa19;43.876999;\n',
        '70001;;2013-01-02;;4;;1;afile/path;arpa19;43.876999;\n',
        '70001;;2013-02-01;;3;68.0;1;afile/path;arpa19;43.876999;\n',
        '70001;;2014-01-01;;2;355.0;0;afile/path;arpa19;43.876999;\n'
    ]
    assert not exists(out_filepath)
    export.export2csv(data, out_filepath, omit_missing=False)
    assert exists(out_filepath)
