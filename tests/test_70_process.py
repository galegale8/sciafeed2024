...
def test_parse_and_check(tmpdir):
    ...
    assert data_parsed == [
        ...
        [metadata, datetime(2013, 1, 1, 1, 0), 'DD', 361.0, False],
        ...
        [metadata, datetime(2013, 1, 1, 2, 0), 'Tmedia', -35.1, False],
        ...
        [metadata, datetime(2013, 1, 1, 4, 0), 'Tmedia', 6.4, False],
        ...
        [metadata, datetime(2013, 1, 1, 5, 0), 'Tmedia', 6.7, False],
        ...
        [metadata, datetime(2013, 1, 1, 6, 0), 'Tmedia', 6.5, False],
        ...
        [metadata, datetime(2013, 1, 1, 7, 0), 'FF', 2.0, True],
        [metadata, datetime(2013, 1, 1, 7, 0), 'DD', 358.0, True],
        [metadata, datetime(2013, 1, 1, 7, 0), 'Tmedia', 6.5, True],
        ...
        [metadata, datetime(2013, 1, 1, 7, 0), 'UR media', 93.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 8, 0), 'FF', 0.5, True],
        [metadata, datetime(2013, 1, 1, 8, 0), 'DD', 342.0, True],
        [metadata, datetime(2013, 1, 1, 8, 0), 'Tmedia', 6.6, True],
        ...
        [metadata, datetime(2013, 1, 1, 9, 0), 'FF', 3.5, True],
        [metadata, datetime(2013, 1, 1, 9, 0), 'DD', 12.0, True],
        [metadata, datetime(2013, 1, 1, 9, 0), 'Tmedia', 10.6, True],
        ...
        [metadata, datetime(2013, 1, 1, 10, 0), 'FF', 1.3, True],
        [metadata, datetime(2013, 1, 1, 10, 0), 'DD', 154.0, True],
        [metadata, datetime(2013, 1, 1, 10, 0), 'Tmedia', 12.1, True],
        ...
        [metadata, datetime(2013, 1, 1, 11, 0), 'FF', 5.4, True],
        [metadata, datetime(2013, 1, 1, 11, 0), 'DD', 218.0, True],
        [metadata, datetime(2013, 1, 1, 11, 0), 'Tmedia', 12.3, True],
        ...
        [metadata, datetime(2013, 1, 1, 12, 0), 'FF', 6.1, True],
        [metadata, datetime(2013, 1, 1, 12, 0), 'DD', 225.0, True],
        [metadata, datetime(2013, 1, 1, 12, 0), 'Tmedia', 12.5, True],
        ...
        [metadata, datetime(2013, 1, 1, 13, 0), 'FF', 6.5, True],
        [metadata, datetime(2013, 1, 1, 13, 0), 'DD', 226.0, True],
        [metadata, datetime(2013, 1, 1, 13, 0), 'Tmedia', 12.2, True],
        ...
        [metadata, datetime(2013, 1, 1, 14, 0), 'FF', 4.6, True],
        [metadata, datetime(2013, 1, 1, 14, 0), 'DD', 221.0, True],
        [metadata, datetime(2013, 1, 1, 14, 0), 'Tmedia', 11.7, True],
        ...
        [metadata, datetime(2013, 1, 1, 14, 0), 'UR media', 78.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 15, 0), 'FF', 1.9, True],
        [metadata, datetime(2013, 1, 1, 15, 0), 'DD', 233.0, True],
        [metadata, datetime(2013, 1, 1, 15, 0), 'Tmedia', 11.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 16, 0), 'FF', 2.8, True],
        [metadata, datetime(2013, 1, 1, 16, 0), 'DD', 355.0, True],
        [metadata, datetime(2013, 1, 1, 16, 0), 'Tmedia', 10.0, True],
        ...
        [metadata, datetime(2013, 1, 1, 16, 0), '12', 1015.8, True],
        ...
        [metadata, datetime(2013, 1, 1, 17, 0), 'FF', 2.4, True],
        [metadata, datetime(2013, 1, 1, 17, 0), 'DD', 345.0, True],
        [metadata, datetime(2013, 1, 1, 17, 0), 'Tmedia', 9.9, True],
        ...
        [metadata, datetime(2013, 1, 1, 18, 0), 'DD', 357.0, True],
        [metadata, datetime(2013, 1, 1, 18, 0), 'Tmedia', 10.1, True],
        ...
        [metadata, datetime(2013, 1, 1, 19, 0), 'FF', 2.6, True],
        [metadata, datetime(2013, 1, 1, 19, 0), 'DD', 2.0, True],
        [metadata, datetime(2013, 1, 1, 19, 0), 'Tmedia', 9.9, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'Tmin', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'Tmax', None, False],
        ...
        [metadata, datetime(2013, 1, 1, 19, 0), 'UR media', 100.0, True],
        [metadata, datetime(2013, 1, 1, 19, 0), 'UR min', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'UR max', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), '12', 1015.4, True],
        [metadata, datetime(2013, 1, 1, 19, 0), 'P', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'Pmin', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'Pmax', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'RADSOL', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'INSOL', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'PREC', None, False],
        [metadata, datetime(2013, 1, 1, 19, 0), 'Bagnatura_f', None, False]
    ]
    # global error
    ...
    assert data_parsed == [
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), 'Tmedia', -57.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), 'UR media', 83.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 1, 0), 'Tmin', 52.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), 'Tmax', 58.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), 'UR media', 79.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 3, 0), 'UR media', 82.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 6, 0), 'UR media', 84.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 7, 0), 'DD', 133.0, False],
        [metadata, datetime(2012, 1, 1, 7, 0), 'Tmedia', 5.9, True],
        [metadata, datetime(2012, 1, 1, 7, 0), 'Tmin', 5.8, True],
        [metadata, datetime(2012, 1, 1, 7, 0), 'Tmax', 6.2, True],
        ...
        [metadata, datetime(2012, 1, 1, 7, 0), 'UR media', 83.0, False],
        [metadata, datetime(2012, 1, 1, 7, 0), 'UR min', 83.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 8, 0), 'DD', 200.0, False],
        [metadata, datetime(2012, 1, 1, 8, 0), 'Tmedia', 7.2, True],
        [metadata, datetime(2012, 1, 1, 8, 0), 'Tmin', 6.2, True],
        [metadata, datetime(2012, 1, 1, 8, 0), 'Tmax', 8.5, True],
        ...
        [metadata, datetime(2012, 1, 1, 8, 0), 'UR media', 82.0, False],
        [metadata, datetime(2012, 1, 1, 8, 0), 'UR min', 80.0, True],
        [metadata, datetime(2012, 1, 1, 8, 0), 'UR max', 85.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 9, 0), 'DD', 160.0, False],
        [metadata, datetime(2012, 1, 1, 9, 0), 'Tmedia', 9.3, True],
        [metadata, datetime(2012, 1, 1, 9, 0), 'Tmin', 8.3, True],
        [metadata, datetime(2012, 1, 1, 9, 0), 'Tmax', 11.1, True],
        ...
        [metadata, datetime(2012, 1, 1, 9, 0), 'UR media', 80.0, False],
        [metadata, datetime(2012, 1, 1, 9, 0), 'UR min', 73.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), 'UR max', 86.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 10, 0), 'DD', 92.0, False],
        [metadata, datetime(2012, 1, 1, 10, 0), 'Tmedia', 12.2, True],
        [metadata, datetime(2012, 1, 1, 10, 0), 'Tmin', 11.1, True],
        ...
        [metadata, datetime(2012, 1, 1, 10, 0), 'UR media', 73.0, False],
        [metadata, datetime(2012, 1, 1, 10, 0), 'UR min', 67.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), 'UR max', 77.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 11, 0), 'DD', 143.0, False],
        [metadata, datetime(2012, 1, 1, 11, 0), 'Tmedia', 13.5, True],
        [metadata, datetime(2012, 1, 1, 11, 0), 'Tmin', 13.4, True],
        [metadata, datetime(2012, 1, 1, 11, 0), 'Tmax', 14.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 11, 0), 'UR media', 74.0, False],
        [metadata, datetime(2012, 1, 1, 11, 0), 'UR min', 68.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), 'UR max', 78.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 12, 0), 'DD', 300.0, False],
        [metadata, datetime(2012, 1, 1, 12, 0), 'Tmedia', 13.9, True],
        [metadata, datetime(2012, 1, 1, 12, 0), 'Tmin', 13.6, True],
        [metadata, datetime(2012, 1, 1, 12, 0), 'Tmax', 14.4, True],
        ...
        [metadata, datetime(2012, 1, 1, 12, 0), 'UR media', 78.0, False],
        [metadata, datetime(2012, 1, 1, 12, 0), 'UR min', 76.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), 'UR max', 82.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 13, 0), 'DD', 260.0, False],
        [metadata, datetime(2012, 1, 1, 13, 0), 'Tmedia', 14.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), 'Tmin', 13.7, True],
        [metadata, datetime(2012, 1, 1, 13, 0), 'Tmax', 14.5, True],
        ...
        [metadata, datetime(2012, 1, 1, 13, 0), 'UR media', 82.0, False],
        [metadata, datetime(2012, 1, 1, 13, 0), 'UR min', 80.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), 'UR max', 85.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 14, 0), 'DD', 236.0, False],
        [metadata, datetime(2012, 1, 1, 14, 0), 'Tmedia', 14.3, True],
        [metadata, datetime(2012, 1, 1, 14, 0), 'Tmin', 13.9, True],
        [metadata, datetime(2012, 1, 1, 14, 0), 'Tmax', 14.7, True],
        ...
        [metadata, datetime(2012, 1, 1, 14, 0), 'UR media', 85.0, False],
        [metadata, datetime(2012, 1, 1, 14, 0), 'UR min', 84.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), 'UR max', 87.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 15, 0), 'DD', 235.0, False],
        [metadata, datetime(2012, 1, 1, 15, 0), 'Tmedia', 14.1, True],
        [metadata, datetime(2012, 1, 1, 15, 0), 'Tmin', 13.4, True],
        [metadata, datetime(2012, 1, 1, 15, 0), 'Tmax', 14.6, True],
        ...
        [metadata, datetime(2012, 1, 1, 15, 0), 'UR media', 86.0, False],
        [metadata, datetime(2012, 1, 1, 15, 0), 'UR min', 85.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), 'UR max', 90.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 16, 0), 'DD', 240.0, False],
        [metadata, datetime(2012, 1, 1, 16, 0), 'Tmedia', 12.8, True],
        [metadata, datetime(2012, 1, 1, 16, 0), 'Tmin', 12.3, True],
        [metadata, datetime(2012, 1, 1, 16, 0), 'Tmax', 13.3, True],
        ...
        [metadata, datetime(2012, 1, 1, 16, 0), 'UR media', 95.0, False],
        [metadata, datetime(2012, 1, 1, 16, 0), 'UR min', 91.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), 'UR max', 98.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 17, 0), 'DD', 246.0, False],
        [metadata, datetime(2012, 1, 1, 17, 0), 'Tmedia', 11.9, True],
        [metadata, datetime(2012, 1, 1, 17, 0), 'Tmin', 11.2, True],
        [metadata, datetime(2012, 1, 1, 17, 0), 'Tmax', 12.3, True],
        ...
        [metadata, datetime(2012, 1, 1, 17, 0), 'UR media', 98.0, False],
        [metadata, datetime(2012, 1, 1, 17, 0), 'UR min', 97.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 18, 0), 'DD', 322.0, False],
        [metadata, datetime(2012, 1, 1, 18, 0), 'Tmedia', 11.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), 'Tmin', 10.6, True],
        [metadata, datetime(2012, 1, 1, 18, 0), 'Tmax', 11.3, True],
        ...
        [metadata, datetime(2012, 1, 1, 19, 0), 'FF', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'DD', 65.0, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'Tmedia', 9.9, True],
        [metadata, datetime(2012, 1, 1, 19, 0), 'Tmin', 9.5, True],
        [metadata, datetime(2012, 1, 1, 19, 0), 'Tmax', 10.6, True],
        ...
        [metadata, datetime(2012, 1, 1, 19, 0), 'UR media', 100.0, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'UR min', 100.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), 'UR max', 100.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'P', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'Pmin', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'Pmax', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'RADSOL', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'INSOL_00', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), 'PREC', 0.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), 'Bagnatura_f', None, False]
    ]
    # global error
    filepath = str(tmpdir.join('report.txt'))
    err_msgs, _ = process.parse_and_check(
    ...
    expected_data_parsed = [
        ...
        [metadata, datetime(2019, 1, 9, 0, 0), 'Tmedia', -2.1667, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'DEWP', -4.4444, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'STP', 848.0, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'VISIB', 5632.69, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'FF', 2.9321, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'MXSPD', 4.1152, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'Tmax', 1.7778, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'Tmin', -5.7778, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'PREC', 3.048, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'SNDP', 149.86, True]
    ]
