...
def test_parse_and_check(tmpdir):
    ...
    assert data_parsed == [
        [metadata, datetime(2013, 1, 1, 0, 0), '1', 2000.0, False],
        ...
        [metadata, datetime(2013, 1, 1, 1, 0), '2', 361.0, False],
        ...
        [metadata, datetime(2013, 1, 1, 2, 0), '3', -351.0, False],
    ...
    assert data_parsed == [
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), '3', -570.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 0, 0), '9', 83.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 1, 0), '4', 520.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), '5', 580.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 2, 0), '9', 79.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 3, 0), '9', 82.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 4, 0), '9', 84.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 5, 0), '9', 84.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 6, 0), '9', 84.0, False],
        ...
        [metadata, datetime(2012, 1, 1, 7, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '2', 133.0, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '3', 59.0, True],
        [metadata, datetime(2012, 1, 1, 7, 0), '4', 58.0, True],
        [metadata, datetime(2012, 1, 1, 7, 0), '5', 62.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 7, 0), '9', 83.0, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '10', 83.0, True],
        [metadata, datetime(2012, 1, 1, 7, 0), '11', 85.0, True],
        [metadata, datetime(2012, 1, 1, 7, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 7, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 7, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '2', 200.0, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '3', 72.0, True],
        [metadata, datetime(2012, 1, 1, 8, 0), '4', 62.0, True],
        [metadata, datetime(2012, 1, 1, 8, 0), '5', 85.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 8, 0), '9', 82.0, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '10', 80.0, True],
        [metadata, datetime(2012, 1, 1, 8, 0), '11', 85.0, True],
        [metadata, datetime(2012, 1, 1, 8, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 8, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 8, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '2', 160.0, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '3', 93.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), '4', 83.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), '5', 111.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 9, 0), '9', 80.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), '10', 73.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), '11', 86.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 9, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 9, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '2', 92.0, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '3', 122.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), '4', 111.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), '5', 140.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 10, 0), '9', 73.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), '10', 67.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), '11', 77.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 10, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 10, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '2', 143.0, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '3', 135.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), '4', 134.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), '5', 140.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 11, 0), '9', 74.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), '10', 68.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), '11', 78.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 11, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 11, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '2', 300.0, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '3', 139.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), '4', 136.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), '5', 144.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 12, 0), '9', 78.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), '10', 76.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), '11', 82.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 12, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 12, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '2', 260.0, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '3', 140.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), '4', 137.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), '5', 145.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 13, 0), '9', 82.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), '10', 80.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), '11', 85.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 13, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 13, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '2', 236.0, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '3', 143.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), '4', 139.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), '5', 147.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 14, 0), '9', 85.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), '10', 84.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), '11', 87.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 14, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 14, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '2', 235.0, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '3', 141.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), '4', 134.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), '5', 146.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 15, 0), '9', 86.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), '10', 85.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), '11', 90.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 15, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 15, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '2', 240.0, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '3', 128.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), '4', 123.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), '5', 133.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 16, 0), '9', 95.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), '10', 91.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), '11', 98.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 16, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 16, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '2', 246.0, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '3', 119.0, True],
        [metadata, datetime(2012, 1, 1, 17, 0), '4', 112.0, True],
        [metadata, datetime(2012, 1, 1, 17, 0), '5', 123.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 17, 0), '9', 98.0, True],
        [metadata, datetime(2012, 1, 1, 17, 0), '10', 97.0, True],
        [metadata, datetime(2012, 1, 1, 17, 0), '11', 100.0, True],
        [metadata, datetime(2012, 1, 1, 17, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 17, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 17, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '2', 322.0, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '3', 110.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), '4', 106.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), '5', 113.0, True],
        ...
        [metadata, datetime(2012, 1, 1, 18, 0), '9', 100.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), '10', 100.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), '11', 100.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 18, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 18, 0), '21', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '1', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '2', 65.0, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '3', 99.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '4', 95.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '5', 106.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '6', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '7', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '8', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '9', 100.0, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '10', 100.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '11', 100.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '12', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '13', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '14', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '15', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '16', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '17', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '18', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '19', None, False],
        [metadata, datetime(2012, 1, 1, 19, 0), '20', 0.0, True],
        [metadata, datetime(2012, 1, 1, 19, 0), '21', None, False]
    ]
    # global error
    filepath = str(tmpdir.join('report.txt'))
    err_msgs, _ = process.parse_and_check(
    ...
    expected_data = [
        ...
        [metadata, datetime(1981, 1, 1, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(1981, 1, 2, 0, 0), 'Tmin', -4.0, True],
        [metadata, datetime(1981, 1, 2, 0, 0), 'Tmax', 5.0, True],
        [metadata, datetime(1981, 1, 2, 0, 0), 'PREC', 0.4, True],
        [metadata, datetime(1981, 1, 3, 0, 0), 'Tmin', -4.0, True],
        [metadata, datetime(1981, 1, 3, 0, 0), 'Tmax', 5.0, True],
        [metadata, datetime(1981, 1, 3, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(1981, 1, 4, 0, 0), 'Tmin', 1.0, True],
        [metadata, datetime(1981, 1, 4, 0, 0), 'Tmax', 9.0, True],
        [metadata, datetime(1981, 1, 4, 0, 0), 'PREC', 14.5, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'Tmin', -8.0, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'Tmax', 3.0, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'PREC', 5.1, True],
        [metadata, datetime(1981, 1, 6, 0, 0), 'Tmin', -8.0, True],
        [metadata, datetime(1981, 1, 6, 0, 0), 'Tmax', -5.0, True],
        [metadata, datetime(1981, 1, 6, 0, 0), 'PREC', 1.0, True],
        [metadata, datetime(1981, 1, 7, 0, 0), 'Tmin', -9.0, True],
        [metadata, datetime(1981, 1, 7, 0, 0), 'Tmax', -5.0, True],
        [metadata, datetime(1981, 1, 7, 0, 0), 'PREC', 6.1, True],
        [metadata, datetime(1981, 1, 8, 0, 0), 'Tmin', -13.0, True],
        [metadata, datetime(1981, 1, 8, 0, 0), 'Tmax', -7.0, True],
        [metadata, datetime(1981, 1, 8, 0, 0), 'PREC', 0.0, True]
    ]
    ...
    assert parsed_data == [
        [metadata, datetime(1981, 1, 3, 0, 0), 'Tmin', -4.0, False],
        [metadata, datetime(1981, 1, 3, 0, 0), 'Tmax', 5.0, True],
        [metadata, datetime(1981, 1, 3, 0, 0), 'PREC', 0.0, True],
        [metadata, datetime(1981, 1, 4, 0, 0), 'Tmin', 1.0, False],
        [metadata, datetime(1981, 1, 4, 0, 0), 'Tmax', 9999.0, False],
        [metadata, datetime(1981, 1, 4, 0, 0), 'PREC', 14.5, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'Tmin', -8.0, False],
        [metadata, datetime(1981, 1, 5, 0, 0), 'Tmax', 3.0, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'PREC', 5.1, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'Tmin', -8.0, False],
        [metadata, datetime(1981, 1, 5, 0, 0), 'Tmax', 3.0, True],
        [metadata, datetime(1981, 1, 5, 0, 0), 'PREC', 5.1, True],
        [metadata, datetime(1981, 1, 6, 0, 0), 'Tmin', -8.0, False],
        [metadata, datetime(1981, 1, 6, 0, 0), 'Tmax', -5.0, True],
        [metadata, datetime(1981, 1, 6, 0, 0), 'PREC', 1.0, True],
        [metadata, datetime(1981, 1, 7, 0, 0), 'Tmin', -9.0, False],
        [metadata, datetime(1981, 1, 7, 0, 0), 'Tmax', -5.0, True],
        [metadata, datetime(1981, 1, 7, 0, 0), 'PREC', 6.1, True],
        [metadata, datetime(1981, 1, 8, 0, 0), 'Tmin', -13.0, True],
        [metadata, datetime(1981, 1, 8, 0, 0), 'Tmax', -7.0, True],
        [metadata, datetime(1981, 1, 8, 0, 0), 'PREC', -3.0, False]
    ]
    # global error
    filepath = str(tmpdir.join('report.txt'))
    ...
    expected_data_parsed = [
        ...
        [metadata, datetime(2019, 1, 9, 0, 0), 'Tmedia', 28.1, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'DEWP', 24.0, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'P', None, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'STP', 848.0, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'VISIB', 3.5, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'FF', 5.7, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'MXSPD', 8.0, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'GUST', None, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'Tmax', 35.2, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'Tmin', 21.6, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'PREC', 0.12, True],
        [metadata, datetime(2019, 1, 9, 0, 0), 'SNDP', 5.9, True]
    ]
    ...
    expected_data = [
        ...
        [metadata, datetime(1930, 5, 9, 9, 0), 'Tmin', 8.0, True],
        [metadata, datetime(1930, 5, 10, 9, 0), 'Tmin', 7.0, True],
        [metadata, datetime(1930, 5, 11, 9, 0), 'Tmin', 500.0, False],
        [metadata, datetime(1930, 5, 12, 9, 0), 'Tmin', 7.0, True],
        [metadata, datetime(1930, 5, 13, 9, 0), 'Tmin', None, True],
        [metadata, datetime(1930, 5, 14, 9, 0), 'Tmin', 9.0, True]
    ]
